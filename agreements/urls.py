...
urlpatterns = [
    ...
    url(r'^nieuw/$', permission_required('agreements.add_agreement')(agreements.views.AddAgreement.as_view()),
        name='add_agreement'),
    url(r'^nieuw/stap-2/(?P<agreement_id>\d+)/$', permission_required('agreements.add_agreement')(agreements.views.AddAgreementStepTwo.as_view()),
        name='new_agreement_step_two'),
