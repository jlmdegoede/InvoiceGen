...
urlpatterns = [
    ...
    url(r'^toevoegen/$', permission_required('orders.view_product')(orders.views.AddProductView.as_view()), name='add_product'),
    ...
    url(r'^verwijder/bijlage/$', orders.views.delete_attachment, name='delete_product_attachment'),
